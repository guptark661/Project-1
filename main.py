...
class save:
    ...
    def bill(self):
        print("\n")
        print("@@@@@@@@@  CROWN PACIFIC RESTRO @@@@@@@@@@@@@@@@")
        print("@@@@@@@@@ Balkumari, Lalitpur, Nepal @@@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@ Quality Service at its best @@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@   Contact us at 986543210   @@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@  info@crownpacific.com.np  @@@@@@@@@@@@@@")
        ...
        for r in a:
            if r not in G:
                print(self.name, " - room", r, "is allocated to you")
                self.room = r
                break
            else:
                continue
