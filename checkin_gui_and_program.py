...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        def chk_name():
            while True:
                ...
                if len(self.k) != 0 and a != True:
                    ...
                    self.Text1.insert(INSERT, "Error !! Invalid input.""\n")
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "Days has been recorded !""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "Error !! Invalid input. ""\n")
                    break
        ...
        root.title("CROWN PACIFIC RESTRO")
        ...
        self.Checkbutton4.configure(text='''SWEET''')
